...
from garden_watch.cli import main
from garden_watch.models import Note, ProjectState, Task
from garden_watch.cli import demo_state
from garden_watch.storage import load_state, save_state
from garden_watch.models import generate_short_id
from garden_watch.validation import normalize_tags, require_text, validate_task_status
from garden_watch.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
